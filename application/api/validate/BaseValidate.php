...
class BaseValidate extends Validate
{
    ...
    protected function isGender($value, $rule='', $data='', $field='')
    {
        $default_array  = array("男", "女");
     ...
     * 验证唯一性的值 $value
    */
    public function isUniqueExceptMe($modelName, $id, $key, $value) {
        $result = Db::name($modelName)->where('id', '<>', $id)->where($key, '=', $value)->find();
        if ($result) {
            return true;
        }
        return false;
